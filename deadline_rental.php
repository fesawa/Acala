								...
								<?php if ($detail['status']=="Pending"): ?>
									...
									<table class="table table-bordered">
										...
										<tr>
											...
											<th>:</th>
											<th><?= $detail['start'] ?> s/d <?= $detail['end'] ?></th>
										</tr>
										<tr>
											<th>Jumlah Mobil</th>
											<th>:</th>
									...
									<?php if ($detail['status']=="Pending"): ?>
										<center><a href="member.php?page=pembayaran_r&id=<?= $id_rental ?>" class="btn btn-primary"> Bayar Sekarang!</a></center>
										<?php else: ?>
											<center><a href="member.php?page=rental" class="btn btn-primary">Riwayat Pesanan</a> </center>
										<?php endif ?>
									</div>
								</div>
